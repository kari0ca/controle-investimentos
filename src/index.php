...
<!-- Barra de navegação --> 
<!-- Depois trocar pela chamada da função que mostra a barra--> 
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="../public/images/porq.jpg" alt="New York">
    ...
    <div class="item">
      <img src="../public/images/invest.jpg" alt="Chicago">
      <div class="carousel-caption">
    ...
    <div class="item">
      <img src="../public/images/din.jpg" alt="Los Angeles">
      <div class="carousel-caption">
...
<!-- Footer -->
<!-- Depois trocar pela chamada da função que mostra o footer --> 
